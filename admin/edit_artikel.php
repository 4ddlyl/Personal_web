      ...
      <form action="proses_edit_artikel.php" method="post" class="space-y-6">
        ...
        <div>
          ...
          <textarea id="isi_artikel" name="isi_artikel" rows="6" required
            class="w-full p-2 rounded bg-transparent"><?php echo htmlspecialchars($data['isi_artikel']); ?></textarea>
        </div>

        <div class="flex justify-end space-x-4">
          <button type="submit"
            class="bg-purple-700 text-white px-4 py-2 rounded hover:bg-purple-800 transition transform hover:scale-105">Update</button>
